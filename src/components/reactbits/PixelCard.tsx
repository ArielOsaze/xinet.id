...
export default function PixelCard({
  ...
  return (
    ...
    >
      ...
      {/* The canvas is absolutely positioned: as a grid child it would take the
          full cell and push the card's content out of view. */}
      <canvas className="absolute inset-0 block h-full w-full" ref={canvasRef} />
